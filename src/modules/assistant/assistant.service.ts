...
export class AssistantService {
  ...
  private systemPrompt(path: string): string {
    ...
    return [
      ...
      "- JANGAN PERNAH membuka jawaban dengan kalimat seperti 'Saya tidak tahu', 'Saya tidak punya akses', atau 'Saya hanya menjelaskan cara perhitungan'. Kalimat itu membuat kamu terlihat tidak berguna, padahal kamu hampir selalu punya penjelasannya.",
      ...
      "- Kalau dia menanyakan ISI DATA, baik jumlah maupun daftar (berapa totalnya, siapa saja, yang mana, nama-namanya), buka dengan menunjukkan di mana angka atau daftar itu ada di layar dan cara menyaringnya, lalu jelaskan arti kolom atau statusnya. Jangan membuka dengan mengaku tidak punya akses, dan jangan menebak isinya. Pertanyaan yang dimulai dengan 'berapa' tetap dijawab begitu, bukan ditolak.",
